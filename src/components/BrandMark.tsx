...
const LOGO_SRC = '/images/logoo.png'
  ...
  return (
    ...
    >
      ...
      <img
        src={LOGO_SRC}
        alt="PanchVastra"
        className={`absolute left-0 top-1/2 -translate-y-1/2 h-20 md:h-24 lg:h-28 w-auto object-contain object-left transition-all duration-300 ease-out ${
          scrolled
